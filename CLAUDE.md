...
| **Camille** | Frontend Builder — GitHub repo (template-nextjs) + Vercel + Penpot export | FastAPI | 8485 | — | active v3.2 (GitHub MCP + /mission, dispatché par Leon, `apply_design_tokens` — branch+patch+PR depuis tokens Penpot) |
