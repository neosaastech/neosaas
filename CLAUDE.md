...
| 55 | Zoho OAuth scope `bugs.ALL` manquant → ✅ résolu 2026-05-29 | Voir anti-pattern #55 — nouveau token via Self Client `1000.ONY9I6H42LISFPE6AEBV961CAIYMTX`, Vault mis à jour. |
| 56 | Zoho `/bugs/` exige form-encoded, pas JSON | Via le connector (`/proxy`) : automatique. Appel direct : utiliser `data=` pas `json=`. |
