...
#   2. Apply pending migrations only (additive, never drops data)
...
#
# SAFE BY DEFAULT: every build only runs `pnpm db:migrate` (additive, tracked
# in __drizzle_migrations, never touches existing rows). The old default used
# to run `pnpm db:hard-reset` (DROP all tables + reseed) on every build unless
# someone remembered to opt out — this is exactly what wiped real production
# data on neosaas-website on 2026-07-07 the first time a preview deployment
# was pointed at the real prod database. A destructive reset must now be an
# explicit, deliberate choice: set ALLOW_DB_HARD_RESET=true.
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
if [ -n "$VERCEL" ] || [ -n "$CI" ]; then
  ...
  if [ "$SKIP_MIGRATIONS" = "false" ]; then
    ...
    if [ "$DB_REACHABLE" = "true" ]; then
      ...
      if [ "${ALLOW_DB_HARD_RESET:-}" = "true" ]; then
        # ─── ÉTAPE 2/4: RECONSTRUCTION COMPLÈTE (destructive, opt-in explicite) ───
        echo "🔄 Étape 2/4 : Reconstruction complète de la base de données"
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        echo "⚠️  ALLOW_DB_HARD_RESET=true — toutes les tables seront supprimées puis recréées"
        ...
        # ─── ÉTAPE 2/4: MIGRATIONS ADDITIVES UNIQUEMENT (défaut sûr) ───
        echo "🔄 Étape 2/4 : Application des migrations en attente (additif, sans perte de données)"
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
