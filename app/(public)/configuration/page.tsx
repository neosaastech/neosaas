      ...
      <Tabs defaultValue="environment" className="w-full">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                <Code className="mr-2 h-5 w-5 text-brand" /> Environment Configuration
              </CardTitle>
              ...
              <div className="space-y-6">
                <div className="bg-[#1A1A1A] text-white p-6 rounded-lg">
                  ...
                  <div className="font-mono text-sm space-y-2">
                    <p>
                      <span className="text-brand">DATABASE_URL</span>
                      =postgresql://user:password@localhost:5432/neosaas
                    </p>
                    <p>
                      <span className="text-brand">JWT_SECRET</span>=your-secure-jwt-secret-key
                    </p>
                    <p>
                      <span className="text-brand">NEXTAUTH_URL</span>=http://localhost:3000
                    </p>
                    <p>
                      <span className="text-brand">NEXTAUTH_SECRET</span>=your-nextauth-secret
                    </p>
                    <p>
                      <span className="text-brand">STRIPE_API_KEY</span>=sk_test_...
                    </p>
                    <p>
                      <span className="text-brand">STRIPE_WEBHOOK_SECRET</span>=whsec_...
                    </p>
                    <p>
                      <span className="text-brand">AWS_S3_BUCKET</span>=your-bucket-name
                    </p>
                    <p>
                      <span className="text-brand">AWS_ACCESS_KEY_ID</span>=your-access-key
                    </p>
                    <p>
                      <span className="text-brand">AWS_SECRET_ACCESS_KEY</span>=your-secret-key
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <Check className="mr-2 h-4 w-4 mt-1 text-brand" />
                        <div>
        ...
        <TabsContent value="database" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                <Database className="mr-2 h-5 w-5 text-brand" /> Database Configuration
              </CardTitle>
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="bg-[#1A1A1A] text-white p-6 rounded-lg">
                  ...
                  <div className="font-mono text-sm space-y-2">
                    <p>
                      <span className="text-brand">// Prisma connection pool example</span>
                    </p>
                    <p>datasource db {"{"}</p>
                    <p>
                      {" "}
        ...
        <TabsContent value="security" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                <Shield className="mr-2 h-5 w-5 text-brand" /> Security Configuration
              </CardTitle>
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="bg-[#1A1A1A] text-white p-6 rounded-lg">
                  ...
                  <div className="font-mono text-sm space-y-2">
                    <p>
                      <span className="text-brand">// next.config.js security headers</span>
                    </p>
        ...
        <TabsContent value="deployment" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                <Cloud className="mr-2 h-5 w-5 text-brand" /> Deployment Configuration
              </CardTitle>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#1A1A1A] text-white p-6 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-brand font-medium mb-2">Frontend</h4>
                    ...
                    <div>
                      <h4 className="text-brand font-medium mb-2">Backend</h4>
                      <ul className="space-y-1 text-sm">
                        <li>Node.js 18+</li>
                        <li>PostgreSQL 15+</li>
                        <li>Prisma ORM</li>
                    ...
                    <div>
                      <h4 className="text-brand font-medium mb-2">Infrastructure</h4>
                      <ul className="space-y-1 text-sm">
                    ...
                    <div>
                      <h4 className="text-brand font-medium mb-2">DevOps</h4>
                      <ul className="space-y-1 text-sm">
