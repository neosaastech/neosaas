            ...
            <CardContent className="space-y-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <div className="flex flex-col">
                  <div className="h-24 rounded-t-lg bg-brand"></div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-4">
                      <button className="bg-brand text-white px-4 py-2 rounded-md">Primary Button</button>
                      <span className="text-sm text-muted-foreground">Primary Action</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <button className="border border-brand text-brand px-4 py-2 rounded-md">
                        Secondary Button
                      </button>
                      <span className="text-sm text-muted-foreground">Secondary Action</span>
                    </div>
                    <div className="flex items-center gap-4">
                      <button className="text-brand px-4 py-2">Tertiary Button</button>
