...
// Brand color for charts (HSL to HEX conversion of hsl(30 61% 50%))
const BRAND_COLOR = "#CD7F32"
const COLORS = ["#0088FE", "#00C49F", "#FFBB28", "#FF8042", "#8884D8", BRAND_COLOR]
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <Link href="/auth/register">
          <Button className="bg-brand hover:bg-[#B26B27] text-white">
            ...
            <CardContent className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="revenue" stroke={BRAND_COLOR} activeDot={{ r: 8 }} />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
            ...
            <CardContent className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <YAxis />
                  <Tooltip />
                  <Area type="monotone" dataKey="growth" stroke={BRAND_COLOR} fill={BRAND_COLOR} />
                </AreaChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
            ...
            <CardContent className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Radar name="Retention %" dataKey="A" stroke={BRAND_COLOR} fill={BRAND_COLOR} fillOpacity={0.6} />
                  <Legend />
                </RadarChart>
              </ResponsiveContainer>
            </CardContent>
            ...
            <CardContent className="h-[400px]">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar dataKey="usage" name="Usage %" fill={BRAND_COLOR} />
                </BarChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
      ...
      <div className="mt-10 rounded-lg border p-8 text-center bg-brand/10 border-brand/20">
