...
export async function GET(request: NextRequest) {
  console.log("🔐 [GitHub OAuth] Initiation de l'authentification");
  ...
  try {
    ...
    if (!config) {
      console.error("❌ [GitHub OAuth] Configuration non trouvée en BDD");
    ...
    // Construire l'URL de redirection GitHub
    ...
    console.error("❌ [GitHub OAuth] Erreur lors de l'initiation:", error);
