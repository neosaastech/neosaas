...
const typeConfig = {
  ...
  appointment: { icon: Calendar, color: 'text-purple-600', bg: 'bg-purple-100 dark:bg-purple-900/30', label: 'Appointments' },
              ...
              {loading ? (
                ...
                <div className="divide-y">
                  {filteredNotifications.map((notification) => {
                    ...
                    const getOrderIcon = () => {
                      if (meta.hasDigital && !meta.hasPhysical && !meta.hasAppointment) {
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between gap-2">
                              ...
                              <div className="flex flex-col items-end gap-1">
                                ...
                                {meta.hasDigital && !meta.hasPhysical && !meta.hasAppointment && (
