...
export function AdminLiveChat() {
  ...
  const createConversation = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.error || "Échec de la création de la conversation")
      }
    } catch (error) {
  ...
  const getUserName = (conv: ChatConversation) => {
    ...
    return conv.guestName || 'Visiteur'
  }
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                ...
                                >
                                  {conv.status === 'open' ? 'Ouvert' :
                                   conv.status === 'pending' ? 'En attente' :
                                   conv.status === 'resolved' ? 'Résolu' : 'Fermé'}
                                </Badge>
