      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          <div className="text-center">
            <div className="inline-block px-4 py-2 bg-brand text-white rounded-md font-semibold mb-4">Frontend</div>
          </div>
        ...
        <div className="space-y-4">
          <div className="text-center">
            <div className="inline-block px-4 py-2 bg-brand text-white rounded-md font-semibold mb-4">Backend</div>
          </div>
        ...
        <div className="space-y-4">
          <div className="text-center">
            <div className="inline-block px-4 py-2 bg-brand text-white rounded-md font-semibold mb-4">
              Deployment
            </div>
          </div>
