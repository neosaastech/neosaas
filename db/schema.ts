 ...
 * - urgent: Priority notifications - Auto-assign + immediate attention
 */
export const notificationCategoryEnum = pgEnum('notification_category', [
  ...
  'urgent',  // Ex: order.urgent (priority badge + auto-assignment)
])
...
/**
 * Product Leads - Track product/consultation interest
 * Track user interest and conversion for products
 */
